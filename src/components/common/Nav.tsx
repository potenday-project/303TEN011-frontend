...
const Nav = () => {
  ...
  return (
    <nav className="fixed bottom-0 z-20 flex h-[60px] w-full min-w-[320px] items-center justify-center gap-[60px] rounded-t-[10px] bg-white sm:left-1/2 sm:max-w-[320px] sm:-translate-x-1/2">
